...
I am not sure about the reliability of these estimates.  In particular, we expect the coefficient of `case_counts` to be positive, since we expect a higher number of mutations with a higher number of cases.
